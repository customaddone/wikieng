...
@section('content')
    ...
    <div class="explain">
        ...
        <p>　　　分をタッチすると検索結果が右上に表示される。<p>

        <h2>　⑷　Wikipedia記事の保存（ここから下はログイン後に使用で</h2>
        <h2>　　　きる機能です。右上の三本線を押してログイン画面からロ</h2>
        <h2>　　　グインして下さい。）</h2>
        ...
        <h2>　⑹　単語の意味、例文保存機能</h2>
        <p>　　　「MY記事」内の記事で単語を検索し、右上の小枠内の検<p>
        <p>　　　検した単語を押すと単語の意味と例文が保存されます。</p>
        <p>　　　保存した単語の意味、例文は右下の水色のボタンを押すと</p>
        <p>　　　閲覧できます。</p>
    </div>
